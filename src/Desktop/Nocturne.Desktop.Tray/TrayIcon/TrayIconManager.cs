...
public sealed class TrayIconManager : IDisposable
{
    ...
    /// <summary>
    /// Updates the tray icon and tooltip with the latest glucose reading.
    /// </summary>
    ...
    /// <summary>
    /// Sets the tray icon to a "connecting" state.
    /// </summary>
    ...
    /// <summary>
    /// Minimal relay command for tray icon click handling.
    /// </summary>
