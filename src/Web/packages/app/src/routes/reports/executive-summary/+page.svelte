...
<div class="container mx-auto px-4 py-6 space-y-8 max-w-6xl">
          ...
          <div class="bg-muted/50 rounded-lg p-3 text-sm space-y-2">
            ...
            <details class="text-xs">
              ...
              <p class="mt-2 text-muted-foreground">
                Calculated using the Nathan formula: eA1C = (GMI + 2.59) / 1.59.
                Based on mean glucose of {stats?.mean?.toFixed(0)} mg/dL over {dayCount}
                days.
              </p>
            </details>
          </div>
        ...
        <CardContent class="space-y-4">
          ...
          {#if totalLows > 4}
            ...
            >
              ...
              You're experiencing more lows than recommended. Discuss with your care
              team about adjusting your treatment.
            </div>
          {:else}
            <div
  ...
  <div class="text-xs text-muted-foreground text-center space-y-1 print:mt-8">
    ...
    <p class="text-muted-foreground/60">
      This report is for informational purposes. Always consult your healthcare
