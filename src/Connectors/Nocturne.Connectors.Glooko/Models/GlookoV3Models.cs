...
namespace Nocturne.Connectors.Glooko.Models
{
    ...
    public class GlookoV3Series
    {
        ...
        [JsonPropertyName("cgmHigh")]
        public GlookoV3GlucoseDataPoint[]? CgmHigh { get; set; }

        [JsonPropertyName("cgmNormal")]
        public GlookoV3GlucoseDataPoint[]? CgmNormal { get; set; }

        [JsonPropertyName("cgmLow")]
        public GlookoV3GlucoseDataPoint[]? CgmLow { get; set; }
        ...
        // BGM readings
        [JsonPropertyName("bgHigh")]
        public GlookoV3GlucoseDataPoint[]? BgHigh { get; set; }

        [JsonPropertyName("bgNormal")]
        public GlookoV3GlucoseDataPoint[]? BgNormal { get; set; }

        [JsonPropertyName("bgLow")]
        public GlookoV3GlucoseDataPoint[]? BgLow { get; set; }

        [JsonPropertyName("bgAbove400")]
        public GlookoV3GlucoseDataPoint[]? BgAbove400 { get; set; }

        // Boluses
        [JsonPropertyName("automaticBolus")]
        public GlookoV3BolusDataPoint[]? AutomaticBolus { get; set; }

        [JsonPropertyName("deliveredBolus")]
        public GlookoV3BolusDataPoint[]? DeliveredBolus { get; set; }

        [JsonPropertyName("injectionBolus")]
        public GlookoV3BolusDataPoint[]? InjectionBolus { get; set; }

        [JsonPropertyName("extendedBolusStep")]
        public GlookoV3BolusDataPoint[]? ExtendedBolusStep { get; set; }

        // Insulin by type
        [JsonPropertyName("gkInsulinBasal")]
        public GlookoV3InsulinDataPoint[]? GkInsulinBasal { get; set; }

        [JsonPropertyName("gkInsulinBolus")]
        public GlookoV3InsulinDataPoint[]? GkInsulinBolus { get; set; }

        [JsonPropertyName("gkInsulinOther")]
        public GlookoV3InsulinDataPoint[]? GkInsulinOther { get; set; }

        [JsonPropertyName("gkInsulinPremixed")]
        public GlookoV3InsulinDataPoint[]? GkInsulinPremixed { get; set; }

        // Basals
        [JsonPropertyName("scheduledBasal")]
        public GlookoV3BasalDataPoint[]? ScheduledBasal { get; set; }

        [JsonPropertyName("temporaryBasal")]
        public GlookoV3BasalDataPoint[]? TemporaryBasal { get; set; }

        [JsonPropertyName("suspendBasal")]
        public GlookoV3BasalDataPoint[]? SuspendBasal { get; set; }

        // Carbs
        [JsonPropertyName("carbAll")]
        public GlookoV3CarbDataPoint[]? CarbAll { get; set; }

        // Alarms and Alerts
        [JsonPropertyName("pumpAlarm")]
        public GlookoV3AlarmDataPoint[]? PumpAlarm { get; set; }

        // Profile Changes
        [JsonPropertyName("profileChange")]
        public GlookoV3ProfileChangeDataPoint[]? ProfileChange { get; set; }

        // Consumable Changes
        [JsonPropertyName("reservoirChange")]
        public GlookoV3ConsumableDataPoint[]? ReservoirChange { get; set; }

        [JsonPropertyName("setSiteChange")]
        public GlookoV3ConsumableDataPoint[]? SetSiteChange { get; set; }

        // LGS/PLGS events (Low Glucose Suspend / Predictive LGS)
        [JsonPropertyName("lgsPlgs")]
        public GlookoV3LgsPlgsDataPoint[]? LgsPlgs { get; set; }

        // Target ranges
        [JsonPropertyName("bgTargets")]
        public GlookoV3TargetDataPoint[]? BgTargets { get; set; }
    }
    ...
    public class GlookoV3BolusData
    {
        ...
        public double? BgInput { get; set; }

        [JsonPropertyName("correctionUnits")]
        public double? CorrectionUnits { get; set; }

        [JsonPropertyName("foodUnits")]
        public double? FoodUnits { get; set; }
    }
    ...
    public class GlookoV3AlarmDataPoint : GlookoV3DataPointBase
    {
        ...
        [JsonPropertyName("data")]
        public GlookoV3AlarmData? Data { get; set; }
    }
    ...
    public class GlookoV3ConsumableDataPoint : GlookoV3DataPointBase
    {
        ...
        [JsonPropertyName("data")]
        public GlookoV3ConsumableData? Data { get; set; }
    }
    ...
    {
        [JsonPropertyName("primeUnits")]
        public double? PrimeUnits { get; set; }

        [JsonPropertyName("fillUnits")]
        public double? FillUnits { get; set; }
    }
