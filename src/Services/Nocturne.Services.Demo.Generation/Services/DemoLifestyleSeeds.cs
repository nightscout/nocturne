    ...
    public const string DefaultClockFaceConfigJson = """
        {
          "rows": [
            ...
            {
              "elements": [
                { "type": "delta", "size": 14, "style": { "color": "muted", "font": "system", "fontWeight": "normal", "opacity": 0.9 } },
                { "type": "age", "size": 14, "style": { "color": "muted", "font": "system", "fontWeight": "normal", "opacity": 0.9 } }
              ]
            }
          ]
        }
