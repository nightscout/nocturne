...
namespace Nocturne.Infrastructure.Data.Migrations
{
    ...
    [Migration("20260926094752_SplitMergedTidepoolDoseGroups")]
    partial class SplitMergedTidepoolDoseGroups
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Nocturne.Infrastructure.Data.Entities.AlertRuleEntity", b =>
                {
                    ...
                    b.Property<string>("ScopeClass")
                        .IsRequired()
                        .HasColumnType("text")
                        .HasColumnName("scope_class");
            ...
            modelBuilder.Entity("Nocturne.Infrastructure.Data.Entities.ConnectorConfigurationEntity", b =>
                {
                    ...
                    b.ToTable("connector_configurations", t =>
                        {
                            t.HasCheckConstraint("ck_connector_configurations_connector_name_lower", "connector_name = lower(connector_name)");
                        });
                });
            ...
            modelBuilder.Entity("Nocturne.Infrastructure.Data.Entities.DeviceClockObservationEntity", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.Property<DateTime?>("CoversFrom")
                        .HasColumnType("timestamp with time zone")
                        .HasColumnName("covers_from");

                    b.Property<DateTime>("CreatedAt")
                        .HasColumnType("timestamp with time zone")
                        .HasColumnName("created_at");

                    b.Property<string>("DeclaredTimezone")
                        .HasMaxLength(64)
                        .HasColumnType("character varying(64)")
                        .HasColumnName("declared_timezone");
                    ...
                    b.HasIndex("TenantId", "Connector", "Source", "ObservedAt")
                        .IsUnique()
                        .HasDatabaseName("ix_device_clock_observations_tenant_connector_source_observed");

                    b.ToTable("device_clock_observations");
                });
            ...
            modelBuilder.Entity("Nocturne.Infrastructure.Data.Entities.DndWindowEntity", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.ToTable("dnd_windows", (string)null);
                });
            ...
            modelBuilder.Entity("Nocturne.Infrastructure.Data.Entities.LabHbA1cResultEntity", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("Nocturne.Infrastructure.Data.Entities.LinkedRecordEntity", b =>
                {
                    ...
                    b.HasIndex("TenantId", "SysCreatedAt")
                    ...
                    b.HasIndex("TenantId", "RecordType", "SourceTimestamp")
            ...
            modelBuilder.Entity("Nocturne.Infrastructure.Data.Entities.OAuthGrantEntity", b =>
                {
                    ...
                    NpgsqlIndexBuilderExtensions.HasOperators(b.HasIndex("LegacyTokenDigest"), new[] { "varchar_pattern_ops" });
            ...
            modelBuilder.Entity("Nocturne.Infrastructure.Data.Entities.ReadAccessLogEntity", b =>
                {
                    ...
                    b.Property<string>("CredentialFingerprint")
                        .HasMaxLength(16)
                        .HasColumnType("character varying(16)")
                        .HasColumnName("credential_fingerprint");
            ...
            modelBuilder.Entity("Nocturne.Infrastructure.Data.Entities.V4.ApsSnapshotEntity", b =>
                {
                    ...
                    b.HasIndex("CorrelationId")
                        .HasDatabaseName("ix_aps_snapshots_correlation_id");
                    ...
                    b.HasIndex("TenantId", "LegacyId")
                        .IsUnique()
                        .HasDatabaseName("ix_aps_snapshots_tenant_legacy_id")
                        .HasFilter("legacy_id IS NOT NULL AND deleted_at IS NULL");

                    b.HasIndex("TenantId", "Timestamp")
                        .IsDescending(false, true)
                        .HasDatabaseName("ix_aps_snapshots_tenant_timestamp")
            ...
            modelBuilder.Entity("Nocturne.Infrastructure.Data.Entities.V4.BasalInjectionEntity", b =>
                {
                    ...
                    b.HasIndex("TenantId", "DataSource", "Timestamp")
                        .IsDescending(false, false, true)
                        .HasDatabaseName("ix_basal_injections_tenant_source_timestamp")
                        .HasFilter("deleted_at IS NULL");

                    b.HasIndex(new[] { "TenantId", "LegacyId" }, "ix_basal_injections_tenant_legacy_id_user_deleted")
                        .HasDatabaseName("ix_basal_injections_tenant_legacy_id_user_deleted")
                        .HasFilter("legacy_id IS NOT NULL AND deleted_by_user");
            ...
            modelBuilder.Entity("Nocturne.Infrastructure.Data.Entities.V4.BasalScheduleEntity", b =>
                {
                    ...
                    b.HasIndex("TenantId", "DataSource", "Timestamp")
                        .IsDescending(false, false, true)
                        .HasDatabaseName("ix_basal_schedules_tenant_source_timestamp")
                        .HasFilter("deleted_at IS NULL");
            ...
            modelBuilder.Entity("Nocturne.Infrastructure.Data.Entities.V4.CarbRatioScheduleEntity", b =>
                {
                    ...
                    b.HasIndex("TenantId", "DataSource", "Timestamp")
                        .IsDescending(false, false, true)
                        .HasDatabaseName("ix_carb_ratio_schedules_tenant_source_timestamp")
                        .HasFilter("deleted_at IS NULL");
            ...
            modelBuilder.Entity("Nocturne.Infrastructure.Data.Entities.V4.DeviceEntity", b =>
                {
                    ...
                    b.HasIndex("TenantId", "Category", "Type", "Serial")
                        .IsUnique()
            ...
            modelBuilder.Entity("Nocturne.Infrastructure.Data.Entities.V4.PumpSnapshotEntity", b =>
                {
                    ...
                    b.HasIndex("CorrelationId")
                        .HasDatabaseName("ix_pump_snapshots_correlation_id");
                    ...
                    b.HasIndex("TenantId", "LegacyId")
                        .IsUnique()
                        .HasDatabaseName("ix_pump_snapshots_tenant_legacy_id")
                        .HasFilter("legacy_id IS NOT NULL AND deleted_at IS NULL");

                    b.HasIndex("TenantId", "Timestamp")
                        .IsDescending(false, true)
                        .HasDatabaseName("ix_pump_snapshots_tenant_timestamp")
                        .HasFilter("deleted_at IS NULL");
                    ...
                    b.HasIndex("TenantId", "DataSource", "Timestamp")
                        .IsDescending(false, false, true)
                        .HasDatabaseName("ix_pump_snapshots_tenant_source_timestamp")
                        .HasFilter("deleted_at IS NULL");

                    b.HasIndex(new[] { "TenantId", "LegacyId" }, "ix_pump_snapshots_tenant_legacy_id_user_deleted")
                        .HasDatabaseName("ix_pump_snapshots_tenant_legacy_id_user_deleted")
                        .HasFilter("legacy_id IS NOT NULL AND deleted_by_user");
            ...
            modelBuilder.Entity("Nocturne.Infrastructure.Data.Entities.V4.SensitivityScheduleEntity", b =>
                {
                    ...
                    b.HasIndex("TenantId", "DataSource", "Timestamp")
                        .IsDescending(false, false, true)
                        .HasDatabaseName("ix_sensitivity_schedules_tenant_source_timestamp")
                        .HasFilter("deleted_at IS NULL");
            ...
            modelBuilder.Entity("Nocturne.Infrastructure.Data.Entities.V4.TargetRangeScheduleEntity", b =>
                {
                    ...
                    b.HasIndex("TenantId", "DataSource", "Timestamp")
                        .IsDescending(false, false, true)
                        .HasDatabaseName("ix_target_range_schedules_tenant_source_timestamp")
                        .HasFilter("deleted_at IS NULL");
            ...
            modelBuilder.Entity("Nocturne.Infrastructure.Data.Entities.V4.UploaderSnapshotEntity", b =>
                {
                    ...
                    b.HasIndex("CorrelationId")
                        .HasDatabaseName("ix_uploader_snapshots_correlation_id");
                    ...
                    b.HasIndex("TenantId", "LegacyId")
                        .IsUnique()
                        .HasDatabaseName("ix_uploader_snapshots_tenant_legacy_id")
                        .HasFilter("legacy_id IS NOT NULL AND deleted_at IS NULL");

                    b.HasIndex("TenantId", "Timestamp")
                        .IsDescending(false, true)
                        .HasDatabaseName("ix_uploader_snapshots_tenant_timestamp")
                        .HasFilter("deleted_at IS NULL");
                    ...
                    b.HasIndex("TenantId", "DataSource", "Timestamp")
                        .IsDescending(false, false, true)
                        .HasDatabaseName("ix_uploader_snapshots_tenant_source_timestamp")
                        .HasFilter("deleted_at IS NULL");

                    b.HasIndex(new[] { "TenantId", "LegacyId" }, "ix_uploader_snapshots_tenant_legacy_id_user_deleted")
                        .HasDatabaseName("ix_uploader_snapshots_tenant_legacy_id_user_deleted")
                        .HasFilter("legacy_id IS NOT NULL AND deleted_by_user");
            ...
            modelBuilder.Entity("Nocturne.Infrastructure.Data.Entities.TenantDemoConfigEntity", b =>
                {
                    b.HasOne("Nocturne.Infrastructure.Data.Entities.TenantEntity", "Tenant")
                        .WithOne("DemoConfig")
                        .HasForeignKey("Nocturne.Infrastructure.Data.Entities.TenantDemoConfigEntity", "TenantId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Nocturne.Infrastructure.Data.Entities.TrackerNotificationThresholdEntity", b =>
                {
                    b.HasOne("Nocturne.Infrastructure.Data.Entities.AlertRuleEntity", null)
                        .WithMany()
                        .HasForeignKey("AlertRuleId")
                        .OnDelete(DeleteBehavior.SetNull);
