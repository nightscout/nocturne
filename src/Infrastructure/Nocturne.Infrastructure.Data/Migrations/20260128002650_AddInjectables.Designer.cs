...
namespace Nocturne.Infrastructure.Data.Migrations
{
    ...
    [Migration("20260128002650_AddInjectables")]
    partial class AddInjectables
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Nocturne.Infrastructure.Data.Entities.InjectableDoseEntity", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.Property<Guid>("InjectableMedicationId")
                        .HasColumnType("uuid")
                        .HasColumnName("injectable_medication_id");
                    ...
                    b.Property<Guid?>("PenVialId")
                        .HasColumnType("uuid")
                        .HasColumnName("pen_vial_id");
                    ...
                    b.Property<DateTimeOffset>("SysCreatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("timestamp with time zone")
                        .HasColumnName("sys_created_at")
                        .HasDefaultValueSql("CURRENT_TIMESTAMP");

                    b.Property<DateTimeOffset>("SysUpdatedAt")
                        .ValueGeneratedOnAddOrUpdate()
                        .HasColumnType("timestamp with time zone")
                        .HasColumnName("sys_updated_at")
                        .HasDefaultValueSql("CURRENT_TIMESTAMP");
                    ...
                    b.HasIndex("InjectableMedicationId", "Timestamp")
                        .IsDescending(false, true)
                        .HasDatabaseName("ix_injectable_doses_medication_timestamp");

                    b.ToTable("injectable_doses");
                });

            modelBuilder.Entity("Nocturne.Infrastructure.Data.Entities.InjectableMedicationEntity", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("injectable_medications");
                });
            ...
            modelBuilder.Entity("Nocturne.Infrastructure.Data.Entities.PenVialEntity", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.Property<double?>("InitialUnits")
                        .HasColumnType("double precision")
                        .HasColumnName("initial_units");
                    ...
                    b.Property<double?>("RemainingUnits")
                        .HasColumnType("double precision")
                        .HasColumnName("remaining_units");
                    ...
                    b.HasIndex("InjectableMedicationId", "Status")
            ...
            modelBuilder.Entity("Nocturne.Infrastructure.Data.Entities.TreatmentEntity", b =>
                {
                    ...
                    b.Property<Guid?>("InjectableDoseId")
                        .HasColumnType("uuid")
                        .HasColumnName("injectable_dose_id");
            ...
            modelBuilder.Entity("Nocturne.Infrastructure.Data.Entities.InjectableDoseEntity", b =>
                {
                    b.HasOne("Nocturne.Infrastructure.Data.Entities.InjectableMedicationEntity", "InjectableMedication")
                        .WithMany("Doses")
                        .HasForeignKey("InjectableMedicationId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Nocturne.Infrastructure.Data.Entities.PenVialEntity", "PenVial")
                        .WithMany("Doses")
                        .HasForeignKey("PenVialId")
                        .OnDelete(DeleteBehavior.SetNull);

                    b.Navigation("InjectableMedication");

                    b.Navigation("PenVial");
                });
            ...
            modelBuilder.Entity("Nocturne.Infrastructure.Data.Entities.TreatmentEntity", b =>
                {
                    b.HasOne("Nocturne.Infrastructure.Data.Entities.InjectableDoseEntity", "InjectableDose")
                        .WithMany()
                        .HasForeignKey("InjectableDoseId")
                        .OnDelete(DeleteBehavior.SetNull);

                    b.Navigation("InjectableDose");
                });
