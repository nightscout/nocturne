...
public class BGCheckRepository
{
    ...
    {
        var query = _context.BGChecks.AsQueryable();
    ...
    public async Task<IEnumerable<BGCheck>> GetByCorrelationIdAsync(Guid correlationId, CancellationToken ct = default)
    {
        var entities = await _context.BGChecks
