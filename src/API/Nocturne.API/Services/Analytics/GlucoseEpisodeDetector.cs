...
internal static class GlucoseEpisodeDetector
{
        ...
        GlycemicThresholds thresholds)
    {
        ...
        int runSide = 0, runStart = 0, severeSide = 0;
        ...
        {
            var zone = (ExcludingZone)zones.Classify(sortedEntries[i].Mgdl);
        ...
        bool MoreExtreme(int candidate, int current) =>
            episodeSide < 0
