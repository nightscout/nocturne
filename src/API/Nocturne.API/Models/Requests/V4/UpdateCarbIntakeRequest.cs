...
/// <summary>
/// Request body for updating an existing carbohydrate intake record via the V4 API.
/// The record is identified by the route-level ID parameter.
/// </summary>
/// <seealso cref="Validators.V4.UpdateCarbIntakeRequestValidator"/>
